...
public class HelpCommand extends AbstractCommand{
    ...
    public void execute(TextChannel textChannel, String content) {
        ...
        embedBuilder.setTitle("도움말")
                ...
                .addBlankField(false)
                .addField("한국경제: 카테고리별 최신뉴스 Top 10 뉴스를 출력합니다.", "/hk {카테고리} [오피니언, 경제, 정치, 사회, 증권, 부동산, 국제, IT, 생활문화, 스포츠, 연]", false)
                .addBlankField(false)
                .addField("조선일보: 카테고리별 조회 수 Top 5 ~ 10 뉴스를 출력합니다.", "/cs {카테고리} [정치, 사회, 국제, 건강, 재테크, 스포츠, 문화연예, 쇼핑]", false)
                .addBlankField(false)
