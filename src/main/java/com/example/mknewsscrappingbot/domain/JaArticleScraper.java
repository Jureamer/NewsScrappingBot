...
@Component
public class JaArticleScraper implements ArticleScraper {
    private final String REQUEST_URL = "https://www.joongang.co.kr/";
    private final String NEWS_WRAP_CSS_SELECTOR = "section.chain_wrap";
    private final String NEWS_NODE_CSS_SELECTOR = "h2.headline";
    private final String ARTICLE_TITLE_CSS_SELECTOR = "h1.headline";
    private final String ARTICLE_CONTENT_CSS_SELECTOR = "#article_body.article_body.fs3";
